...
import { addNote,deleteNote } from '../states/redux/notesSlice'
import AddNote from './AddNote'

const NoteItem = ({title,description,tag,id})=>{
    useDispatch
    return(
            ...
            <div className="card my-3">
                <div className="card-body">
                    <div className="d-flex align-items-center">
                        ...
                        <i className="far fa-trash-alt mx-2" onClick={()=>{dispatch(deleteNote(id))}} ></i>
